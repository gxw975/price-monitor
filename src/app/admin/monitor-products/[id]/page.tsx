...
interface Product { product_id: string; title: string; shop_name: string; main_image_url: string; image_url: string; price: number; sales: number; seller_name: string; platform: string; shop_type: string; location: string; url: string; is_approved: boolean }
